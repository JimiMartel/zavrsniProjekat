...
function updateUserInterface() {
    ...
    let personalBtn2 = document.querySelector('.dropdown--content--header .personal--btn .initials');
    let personalName = document.querySelector('.dropdown--content--header--name');
    let personalEmail = document.querySelector('.dropdown--content--header--email');
    ...
    if (activeUser) {
        initialsElement.innerHTML = activeUser.initials;
        personalBtn2.innerHTML = activeUser.initials;
        personalName.innerHTML = activeUser.name;
        personalEmail.innerHTML = activeUser.email;
